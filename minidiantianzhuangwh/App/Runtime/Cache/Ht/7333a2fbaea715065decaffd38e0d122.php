...
<div class="aaa_pts_show_2">
    <div>
       <div class="aaa_pts_4"><a href="<?php echo U('index');?>">全部企业</a></div>
    </div>
    <div class="aaa_pts_3">
      <div class="pro_4 bord_1">
         <div class="pro_5">企业名称：<input type="text" class="inp_1 inp_6" id="name" value="<?php echo ($name); ?>"></div>
         <div class="pro_5">
               推荐企业：
               <select class="inp_1 inp_6" id="tuijian">
			      <option value="">全部企业</option>
                  <option value="1" <?php echo ($tuijian=='1' ? 'selected=selected' : NULL); ?>>推荐企业</option>
                  <option value="0" <?php echo ($tuijian=='0' ? 'selected=selected' : NULL); ?>>非推荐企业</option>
	           </select>
         </div>
      ...
      <table class="pro_3">
         ...
         <!-- 遍历 -->
          <?php if(is_array($shangchang)): $i = 0; $__LIST__ = $shangchang;if( count($__LIST__)==0 ) : echo "暂时没有店铺，赶紧进行招商吧" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($v["id"]); ?>" data-name="<?php echo ($v["name"]); ?>">
             <td><?php echo ($v["id"]); ?></td>
             <td><img src="/minidiantianzhuangwh/Data/<?php echo ($v["logo"]); ?>" class="img_1"/></td>
             ...
             <td class="obj_1">
              <a href="<?php echo U('Shangchang/set_tj');?>?id=<?php echo ($v["id"]); ?>">推荐</a> |
              ...
              <a href="<?php echo U('Shangchang/add');?>?id=<?php echo ($v["id"]); ?>&page=<?php echo ($page); ?>&name=<?php echo ($name); ?>&sheng=<?php echo ($v["sheng"]); ?>&city=<?php echo ($v["city"]); ?>&quyu=<?php echo ($v["quyu"]); ?>&tiaojian=<?php echo ($v["tuijian"]); ?>">修改</a> |
